export default function Example() {
    return (
      <div className="relative bg-white py-16 sm:py-24" id="about">
        <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-24 lg:items-start">
          <div className="relative sm:py-16 lg:py-0">
            ...
            <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0 lg:max-w-none lg:py-20">
              {/* Testimonial card*/}
              <div className="mt-16">
                <img src="./assets/2.jpg" alt="HR360Cloud" />
              </div>
          ...
          <div className="relative mx-auto max-w-md pt-16 px-4 sm:max-w-3xl sm:px-6 lg:px-0">
            ...
            <div className="pt-12 sm:pt-16 lg:pt-20">
              ...
              <span className="text-blue-600">HR360Cloud:</span> a Comprehensive All-in-One HR Software for Seamless Employee Management from Hire to Retire.
              </h2>
