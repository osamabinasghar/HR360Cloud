            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div>
                    ...
                    <nav className="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
                        ...
                        <div className="flex items-center justify-between w-full md:w-auto">
                            ...
                            <img className="h-10 w-auto sm:h-10" src="../../assets/logo.svg" />
                            </a>
                ...
                <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                    ...
                    <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                        <span className="block xl:inline">A Complete </span>
                        <span className="block text-blue-600 xl:inline">HR </span>
                        <span className="block xl:inline">Solution for Every </span>
                        <span className="block text-blue-600 xl:inline">Business</span>
                    </h1>
